  ...
  switch (serType) {
    ...
    case "venue-provider":
      fieldsToCheck = [
        ...
        {
          path: "featureDetails.accessibilityFeatures",label: "Accessibility Features",
        },
        {
          path: "featureDetails.restrictionsPolicies",label: "Restrictions at Venue",
        },
        { path: "featureDetails.facilities", label: "Facilities at Venue" },

        // Services
        {
          path: "featureDetails.catererServices",label: "In-House Catering Service",
        },
        {
          path: "featureDetails.decorServices",label: "In-House Decoration Service",
        },
