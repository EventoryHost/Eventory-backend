...
const ReduxDjArtistSchema = new mongoose.Schema(
  {
    ...
    service_id: { type: String, unique: true, index: true },
    vendor_id: { type: String, index: true },
    service_type: { type: String, default: "DJ-Artist" }, // match source model
    ...
    event_types_performed: { type: [String] },
    music_genres_specialized: { type: [String] },
    regional_specializations: { type: [String] },

    // Service Location (flattened from basic_details.service_location_dj_artist)
    ...
    sound_system_specifications: { type: String },
    lighting_equipment_available: { type: [String] },
    is_mc_services_provided: { type: Boolean },
    is_karaoke_services_available: { type: Boolean },
    is_custom_playlist_creation: { type: Boolean },
    performance_duration_options: { type: [String] },

    // Additional Details (flattened from additional_details)
    asset_images: { type: [String] },
    asset_videos: { type: [String] },
    performance_samples: { type: [String] },
    ...
    awards_achievements: { type: String },
