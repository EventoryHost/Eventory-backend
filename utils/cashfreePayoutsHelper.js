...
export const VALID_VPA_HANDLES = [
  "upi", "sbi", "axisbank", "hdfcbank", "icici", "kotak", "kotak811",
  "yesbank", "pnb", "barodampay", "allbank", "indianbank", "unionbank",
  "centralbank", "canara", "cnrb", "uco", "iob", "idbi", "rbl", "indus",
  "federal", "dbs", "hsbc", "citi", "citigold", "bandhan", "aubank",
  "equitas", "fincarebank", "dlb", "kbl", "sib", "boi", "mahb", "jkb",
  "okaxis", "okhdfcbank", "okicici", "oksbi",
  "ybl", "ibl", "axl",
  "paytm", "ptaxis", "ptyes", "ptsbi", "pthdfc",
  "apl", "yapl", "rapl",
  "sliceaxis", "slicepay", "slc", "axisb", "yescred", "yescurie", "fam",
  "yesfam", "inhdfc", "jupiteraxis", "naviaxis", "mvhdfc", "oneyes",
  "fifederal", "kphdfc", "seyes", "abcdicici", "jarunity", "rmrbl", "kbaxis",
  "freecharge", "ikwik", "airtel", "jio", "payu", "trans", "timecosmos",
  "yespay", "yespop", "bpunity", "paulpay", "finobank", "pingpay", "fkaxis",
  "zoicici", "shriramhdfcbank", "mboi", "axb",
  "waicici", "pz", "indie", "yesg",
];
...
export function validateVPA(vpa) {
  ...
  if (!formatRegex.test(trimmed)) {
    return { valid: false, error: "Invalid UPI ID format. Expected format: username@bank" };
  }

  const handle = trimmed.split("@")[1];
  if (!VALID_VPA_HANDLES.includes(handle)) {
    return { valid: false, error: `Invalid UPI handle '@${handle}'. Please enter a valid UPI ID.` };
  }
