...
export const uploadChatMedia = async (req, res) => {
  ...
  try {
    ...
    console.log("Server received file for local storage:", {
    ...
    // Use the local filename generated by multer to ensure uniqueness
    const fileKey = `chat/media/${folder}${req.file.filename}`;
