...
const searchVenues = async (query) => {
  ...
  if (query.minPrice || query.maxPrice) {
    ...
    if (query.minPrice)
      filters["filters.startingPrice"].$gte = parseInt(query.minPrice, 10);
    if (query.maxPrice)
      filters["filters.startingPrice"].$lte = parseInt(query.maxPrice, 10);
  }
...
const searchCaterers = async (query) => {
  ...
  if (query.minPrice || query.maxPrice) {
    ...
    if (query.minPrice)
      filters["filters.price"].$gte = parseInt(query.minPrice, 10);
    if (query.maxPrice)
      filters["filters.price"].$lte = parseInt(query.maxPrice, 10);
  }
