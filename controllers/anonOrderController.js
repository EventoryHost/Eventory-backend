    ...
    if (anon_order_id) {
      ...
      if (order_status === 'approved') {
        ...
        const newOrder = await Orders.create({
          em_id: em_id || existingOrder.em_id,
          service_id: service_id || existingOrder.service_id,
          vendor_id: vendorId,
          quotation_id: anonOrderId,
          vendor_manager_name,
          customer_name: customer_name || existingOrder.customer_name,
          customer_id: anonUserId,
          event_start: event_start || existingOrder.event_start,
          event_end: event_end || existingOrder.event_end,
          event_type: event_type || existingOrder.event_type,
          final_guest_count: guest_count || existingOrder.guest_count,
          location_type: location_type || existingOrder.location_type,
          event_location: event_location || existingOrder.event_location,
          final_amount: finalAmountToStore,
          advance_amount_requested: advance_amount_requested || existingOrder.advance_amount_requested,
          ...
          customer_contact_email: customer_contact_email || existingOrder.customer_contact_email,
